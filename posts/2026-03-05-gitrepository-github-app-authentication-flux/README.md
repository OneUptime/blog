...
- A Kubernetes cluster with Flux CD v2.5.0 or later installed
...
- **Scalable rate limits**: GitHub Apps using installation access tokens have a minimum rate limit of 5,000 requests per hour per installation, and the limit can scale higher depending on the installation and GitHub plan.
