...
If you are already using CloudWatch alarms across your accounts, consider pairing dashboards with cross-account alarm forwarding. For more on setting up alarms, check out our post on [creating CloudWatch alarms for Lambda error rates](https://oneuptime.com/blog/post/create-cloudwatch-alarms-for-lambda-error-rates/view). And for centralizing monitoring even further, take a look at our guide on [centralized monitoring for multi-account AWS](https://oneuptime.com/blog/post/set-up-centralized-monitoring-for-multi-account-aws/view).
