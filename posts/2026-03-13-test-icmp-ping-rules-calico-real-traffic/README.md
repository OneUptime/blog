# How to Test ICMP and Ping Rules in Calico with Real Traffic

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, ICMP, Testing

Description: Validate Calico ICMP and ping network policy rules using real traffic tests to confirm ICMP controls work correctly.

---

## Introduction

Testing ICMP and Ping Rules in Calico requires systematic verification that your policy rules produce the expected traffic behavior. By sending real traffic through a test environment, you can confirm both positive scenarios (allowed traffic passes) and negative scenarios (denied traffic is blocked).
...
## Step 3: Apply ICMP Rules Policy and Test Blocking
