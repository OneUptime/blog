...
Requirements:
- Kubernetes 1.16–1.22 (ephemeral containers in alpha, requires enabling the EphemeralContainers feature gate)
- Kubernetes 1.23+ (ephemeral containers in beta, enabled by default)
