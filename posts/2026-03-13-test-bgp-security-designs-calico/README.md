# How to Test BGP Security Designs in Calico with Live Workloads

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, BGP, Security, Networking

Description: Test BGP security controls in Calico under live conditions to verify that unauthorized route injection attempts are blocked.
...
- calicoctl v3.29+ (required for BGPFilter `prefixLength` support)
