...
In Portainer, go to **Containers**, select the container you want to duplicate, then click **Duplicate/Edit**.

Enter a new container name, review the copied configuration, then click **Deploy the container**.
