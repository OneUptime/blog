...
Building an IDP pipeline is an iterative process. Start with your most common document types, measure extraction accuracy, and gradually expand coverage. The human review loop is essential early on - it catches errors and generates training data for improving your classifiers. For more on the extraction layer, see our guides on [Textract document processing](https://oneuptime.com/blog/post/amazon-textract-document-processing/view) and [extracting tables and forms](https://oneuptime.com/blog/post/extract-tables-forms-amazon-textract/view).
