...
Calico kube-controllers exposes Prometheus metrics on port 9094 that provide visibility into IPAM allocation state and process health. These metrics are essential for monitoring the health of Calico's control plane in large clusters.
