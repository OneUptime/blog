...
For related security monitoring, check out our posts on [detecting unauthorized API calls with CloudTrail and EventBridge](https://oneuptime.com/blog/post/detect-unauthorized-api-calls-with-cloudtrail-and-eventbridge/view) and [monitoring API call patterns with CloudTrail Insights](https://oneuptime.com/blog/post/monitor-aws-api-call-patterns-with-cloudtrail-insights/view). For multi-account setups, see [CloudTrail Organization Trail for multi-account](https://oneuptime.com/blog/post/set-up-cloudtrail-organization-trail-for-multi-account/view).
