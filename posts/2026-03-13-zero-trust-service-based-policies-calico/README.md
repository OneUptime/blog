...
- Calico configured to use the Kubernetes API datastore
...
# List policies in the namespace and inspect their selectors
...
flowchart TD
    ...
    F[No Policy Update Required] -->|Service scales| B
