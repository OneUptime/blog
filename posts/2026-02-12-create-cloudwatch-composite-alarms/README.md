...
Start by identifying your most common alert storms - incidents where multiple alarms fire simultaneously. Those are your first candidates for composite alarms. For more on the individual metrics that feed into these alarms, see our guide on [creating CloudWatch metric alarms](https://oneuptime.com/blog/post/create-cloudwatch-metric-alarms/view). And for ML-powered anomaly detection, check out [CloudWatch anomaly detection for alarms](https://oneuptime.com/blog/post/cloudwatch-anomaly-detection-alarms/view).
