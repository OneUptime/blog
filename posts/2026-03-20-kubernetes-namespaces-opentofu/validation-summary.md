# Validation Summary: How to Manage Namespaces with OpenTofu on Kubernetes
...
- HashiCorp Kubernetes provider `kubernetes_namespace` resource docs: https://github.com/hashicorp/terraform-provider-kubernetes/blob/main/docs/resources/namespace.md
