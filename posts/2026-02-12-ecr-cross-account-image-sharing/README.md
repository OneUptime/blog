...
3. **Enable image scanning** - Scan images in the source account and gate deployments on scan results before deployment accounts use them (see our post on [ECR image scanning](https://oneuptime.com/blog/post/2026-02-12-ecr-image-scanning-vulnerabilities/view))
