# Validation Summary: How to Set Up Service-Level Resource Constraints in Portainer Stacks - A Practical Guide
...
- Compose service resource constraints
...
## Issues Found
- The post described the resource controls as "stack-level", but Compose `deploy.resources` limits and reservations are service-level settings. Updated the title, description, and introduction to describe service-level constraints in Portainer stacks.
