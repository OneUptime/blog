...
# View policy details
calicoctl get stagedglobalnetworkpolicy monitor-policy -o yaml

# Delete a policy if needed
calicoctl delete stagedglobalnetworkpolicy monitor-policy
```
...
3. **Order conflicts**: Run `calicoctl get stagedglobalnetworkpolicies -o wide` and sort by order field
