...
# Make permanent (Debian/Ubuntu with ifupdown): add a post-up line under the
# relevant interface stanza in /etc/network/interfaces, e.g.:
#   post-up ip route add 10.244.0.0/16 via <kubernetes-node-ip>
```
