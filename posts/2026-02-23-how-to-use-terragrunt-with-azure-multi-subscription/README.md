...
locals {
  ...
  environment       = "dev"
  tenant_id         = "12345678-abcd-4ef0-8abc-123456789012"
}
```
...
locals {
  subscription_id   = "ffffffff-1111-2222-3333-444444444444"
...
# Resources in this module should set provider = azurerm.hub or provider = azurerm.spoke.
# The provider instances are generated by Terragrunt for this module.
```
...
```hcl
locals {
  dev_config    = read_terragrunt_config(find_in_parent_folders("subscription.hcl"))
  shared_config = read_terragrunt_config("../../../shared/subscription.hcl")

  dev_subscription_id    = local.dev_config.locals.subscription_id
  dev_tenant_id          = local.dev_config.locals.tenant_id
  shared_subscription_id = local.shared_config.locals.subscription_id
  shared_tenant_id       = local.shared_config.locals.tenant_id
}
...
provider "azurerm" {
  ...
  tenant_id       = "${local.shared_tenant_id}"
  alias           = "hub"
}
EOF
}
