...
When you need to customize generated files, use Projen's escape hatches instead of editing them by hand:

```typescript
// Customize a managed object file
project.tryFindObjectFile('tsconfig.json')?.addOverride('compilerOptions.paths', {
  '@/*': ['./src/*'],
});

// Or create a generated file without the "generated by projen" marker
