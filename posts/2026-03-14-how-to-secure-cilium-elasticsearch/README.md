...
hubble observe --verdict DROPPED --namespace logging --output compact
...
- **Legitimate traffic blocked**: Check Hubble for specific drop reasons with `hubble observe --verdict DROPPED --namespace logging`.
