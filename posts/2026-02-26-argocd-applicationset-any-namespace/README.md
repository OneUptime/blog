...
This feature requires ArgoCD v2.8 or later. It also requires the Applications in any namespace feature to be enabled with the same namespace list, because Applications generated by an ApplicationSet are created in the same namespace as the ApplicationSet.
...
The ApplicationSet controller needs permission to watch ApplicationSets and manage generated Applications in the specified namespaces. If you want Applications in team namespaces to be managed through the ArgoCD API, CLI, or UI, also apply the ArgoCD server RBAC for Applications in any namespace.
...
### Step 3: Restart the Controllers
...
data:
  application.namespaces: "team-a,team-b"
  applicationsetcontroller.namespaces: "team-a,team-b"
  # Disable the SCM provider and pull request generators
