...
For Next.js applications, see [setting up Amplify Hosting for a Next.js app](https://oneuptime.com/blog/post/amplify-hosting-nextjs-app/view). And for the overall Amplify ecosystem, check out [getting started with AWS Amplify](https://oneuptime.com/blog/post/aws-amplify-getting-started/view).
