...
Perform an in-place upgrade of RHEL images on Azure. RHEL 9 is fully supported on major cloud platforms with official images and integrated tooling.
...
You have learned how to perform an in-place upgrade of rhel images on azure. RHEL 9 on cloud platforms benefits from official support, pre-configured images, and integration with Red Hat management tools.
