...
- The Hubble CLI installed if you plan to run the Hubble flow examples
...
# cilium_datapath_conntrack_gc_entries - core operational metric
...
sum(cilium_datapath_conntrack_gc_entries) by (family)
