...
spec:
  ...
  # Deny these namespace-scoped resource kinds
...
spec:
  ...
  roles:
    ...
    - name: ci
      ...
      # JWT token metadata for tokens generated by the Argo CD API server
      jwtTokens:
        - iat: 1700000000
          exp: 1800000000
```
...
data:
  ...
  # Subscribe all applications to the audit trigger
  subscriptions: |
    - recipients:
        - audit
      triggers:
