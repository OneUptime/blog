...
Using rsync for incremental cross-site backup:

```bash
sudo rsync -aAXv --delete --exclude={/proc,/sys,/dev,/run,/tmp,/backups} / backupuser@dr.example.com:/backups/latest/
```
...
# For rsync
ssh backupuser@dr.example.com "ls -la /backups/latest/"
```
