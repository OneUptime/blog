...
kubectl get ciliumendpoints -n logging -o json | \
...
Apply a focused validation policy for the test workloads before checking allowed and denied flows:
