# How to Create VMDK Images for VMware from RHEL Image Builder

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: RHEL, Image Builder, VMDK, VMware

Description: Create VMDK images for VMware using RHEL Image Builder.

---

## Overview

Create VMDK images for VMware using RHEL Image Builder. RHEL Image Builder lets you create customized, deployable operating system images for physical, virtual, and cloud environments.
...
You have learned how to create vmdk images for vmware from rhel image builder. Image Builder provides a consistent workflow for creating RHEL images across all deployment targets.
