...
VPC Flow Logs combined with Logs Insights give you powerful network visibility. Whether you're troubleshooting a connectivity issue, investigating a security incident, or understanding your traffic patterns, these queries will get you answers fast. For more on the query syntax behind these examples, see our [Logs Insights query syntax guide](https://oneuptime.com/blog/post/cloudwatch-logs-insights-query-syntax/view). And if you want to keep flow logs long-term at lower cost, check out [exporting CloudWatch Logs to S3](https://oneuptime.com/blog/post/export-cloudwatch-logs-s3/view).
