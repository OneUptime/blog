# Validation Summary: How to Use Terradocs to Generate Documentation for OpenTofu
...
- GitHub artifact actions documentation and v3 deprecation notice: https://github.com/actions/upload-artifact

## Issues Found
- The post title used "Terradocs" while the article description and relevant official tooling are for `terraform-docs`. I corrected the post title and examples to use `terraform-docs`.
- The post promised documentation generation, but the body showed a generic OpenTofu deployment workflow and did not install, configure, or run `terraform-docs`. I replaced the unrelated plan/apply workflow with terraform-docs installation, README injection, output checking, and configuration examples.
