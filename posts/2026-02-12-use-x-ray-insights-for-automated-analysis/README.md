...
For setting up the tracing pipeline itself, check out our guides on [X-Ray daemon on EC2](https://oneuptime.com/blog/post/set-up-x-ray-daemon-on-ec2-for-tracing/view) and [X-Ray with ECS sidecar containers](https://oneuptime.com/blog/post/use-x-ray-with-ecs-sidecar-container/view). If you want to pair insights with SLO monitoring, see our post on [CloudWatch Application Signals for SLO monitoring](https://oneuptime.com/blog/post/use-cloudwatch-application-signals-for-slo-monitoring/view).
