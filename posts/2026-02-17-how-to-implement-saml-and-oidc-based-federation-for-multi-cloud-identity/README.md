...
OIDC federation is the simpler of the two protocols. Here is how to set up Workload Identity Federation for multi-cloud service-to-service authentication, including AWS-specific and OIDC providers.
...
```mermaid
graph LR
    A[AWS Lambda] -- AWS SigV4 Token --> B[GCP Workload Identity]
