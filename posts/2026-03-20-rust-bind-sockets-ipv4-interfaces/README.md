...
Description: Bind Rust TCP listener and client sockets to specific IPv4 addresses to control listener addresses and source IP selection on multi-homed hosts.
