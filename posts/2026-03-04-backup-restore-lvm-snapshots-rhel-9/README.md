...
You have learned how to backup and restore lvm snapshots. Remember the 3-2-1 rule: keep three copies of your data, on two different media types, with one copy stored off-site.
