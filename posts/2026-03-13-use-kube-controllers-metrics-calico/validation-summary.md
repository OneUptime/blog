# Validation Summary: How to Use Calico Kube-Controllers Metrics
...
## Issues Found
- The post described kube-controllers metrics as visibility into the "policy distribution layer" and "synchronization health." Calico's documented kube-controllers-specific metrics are IPAM allocation metrics, alongside default Go and process metrics. I updated the description, introduction, and conclusion to refer to IPAM allocation state and process health.
