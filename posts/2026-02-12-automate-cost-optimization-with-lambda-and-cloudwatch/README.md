...
For the broader strategy, see our guide on [creating a cost optimization strategy for AWS](https://oneuptime.com/blog/post/create-a-cost-optimization-strategy-for-aws/view). And for finding resources to automate against, check out [identifying idle and unused AWS resources](https://oneuptime.com/blog/post/identify-idle-and-unused-aws-resources/view).
